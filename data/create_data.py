...
print("code started.")
xyz_dir = 'D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/pybel_xyz/with_H/'

with open("D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/fragments.dat", "rb") as f:
    fragments = pickle.load(f)

# load the data downloaded from  
# https://figshare.com/s/6258a546a27a2373bf2a/articles/14558808
df = pd.read_csv("D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/data.csv", encoding='iso-8859-1')
...
if dups.shape[0] !=0:
    ...
    train.to_csv("D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/train.csv", index=False)
    test.to_csv("D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/test.csv", index=False)
    val.to_csv("D:/Study/Zhang_Hao/CS230/Project/code/ACS_omega/data/val.csv", index=False)
